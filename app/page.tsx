        ...
        <section className="py-20 pl-6 bg-white relative">
          <div className="max-w-[1300px] mx-auto">
            <div className="flex flex-col lg:flex-row items-center">
              <div className="w-full lg:max-w-[450px] pr-8 order-1">
                <h1 className={`text-6xl font-bold mb-6 text-left ${inter.className}`}>
                  Create personalized workout plans <br />with just a few clicks.
                </h1>
                <p className="text-xl text-neutral-600 mb-8 text-left">
                ...
                <div className="flex gap-4 items-center">
                  ...
                  <Button className="bg-black text-white hover:bg-neutral-800">Join the Waitlist</Button>
                </div>
              </div>
              <div className="w-full lg:flex-1 flex justify-end order-2 mt-12 lg:mt-0 pl-16 pr-6">
                <img 
          ...
          <div className="max-w-[1300px] mx-auto">
            <div className="pt-16">
              ...
              <div className="flex flex-col lg:flex-row items-center gap-16">
                ...
                <div className="w-full lg:flex-[1.5] flex justify-end mt-8 lg:mt-0 pl-20 pr-6">
                  <div className="relative">
                    ...
                    <img 
                      ...
                      className="w-auto h-auto max-h-[1500px]"
                    />
                  </div>
                </div>
              </div>
          ...
          <div className="max-w-[1300px] mx-auto">
            <div className="pt-16">
              ...
              <div className="flex flex-col lg:flex-row gap-16 items-center">
                ...
                <div className="w-full lg:flex-[1.2] flex justify-end pl-20">
                  <div className="relative pl-[90px] -ml-80">
                    <img 
                      src="/images/app_stats2.png" 
                      alt="PeakFit AI Exercise Page" 
                      className="w-auto h-auto max-h-[1200px]"
                    />
                  </div>
                </div>
              </div>
